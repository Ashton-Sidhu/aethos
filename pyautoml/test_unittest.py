...
class Test_TestBase(unittest.TestCase):
    ...
    def test_setitem_constant(self):
        ...
        base = MethodBase(x_train=data, x_test=None, split=True, target_field='', target_mapping=None, report_name=None, test_split_percentage=0.25)
    ...
    def test_setitem_equalsize_list(self):
        ...
        base = MethodBase(x_train=data, x_test=None, split=True, target_field='', target_mapping=None, report_name=None, test_split_percentage=0.5)
    ...
    def test_setitem_testdata(self):
        ...
        base = MethodBase(x_train=data, x_test=None, split=True, target_field='', target_mapping=None, report_name=None, test_split_percentage=0.75)
    ...
    def test_dropcolumns_complex(self):
        ...
        clean = Clean(x_train=data, x_test=None, split=True, target_field='', report_name="test", test_split_percentage=0.5)
    ...
    def test_getattr(self):
        ...
        base = MethodBase(x_train=data, x_test=None, split=True, target_field='', target_mapping=None, report_name="test", test_split_percentage=0.5)
    ...
    def test_setter(self):
        ...
        base = MethodBase(x_train=data, x_test=None, split=False, target_field='', target_mapping=None, report_name="test", test_split_percentage=0.5)
    ...
    def test_where(self):
        ...
        base = MethodBase(x_train=data, x_test=None, split=False, target_field='', report_name="test", target_mapping=None, test_split_percentage=0.5)
    ...
    def test_groupby(self):
        ...
        clean = Clean(x_train=data, x_test=None, split=False, target_field='', report_name="test", test_split_percentage=0.5)
    ...
    def test_encodelabels(self):
        ...
        clean = Clean(x_train=data, x_test=None, split=False, target_field='D', report_name="test", test_split_percentage=0.5)
        clean.encode_target()
